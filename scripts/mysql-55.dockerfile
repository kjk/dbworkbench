# based on https://github.com/docker-library/mysql/blob/ac05512a1b788e8ae658d0f4a980ff7a01a51c93/5.5/Dockerfile
FROM debian:jessie
...
COPY scripts/mysql-55-docker-entrypoint.sh /entrypoint.sh
COPY tmp_data/world-mysql.sql /docker-entrypoint-initdb.d/world.sql 
